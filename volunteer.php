...
<body>
    <div class="container">
        ...
        if (isset($_POST["submit"])) 
        {
            ...
            {
                require_once "database.php";
                $sql = "INSERT INTO volunteer_info (fname, email, phone, age, address, resume, skills, comment, options) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
                $stmt = mysqli_stmt_init($conn);
                $prepareStmt = mysqli_stmt_prepare($stmt,$sql);
                if($prepareStmt) 
                {
                    mysqli_stmt_bind_param($stmt,"ssiisssss",$fname, $email, $phone, $age, $address, $resume, $skills, $comment, $options);
        ...
        ?>
                    ...
                    <form id="volunteerForm" action="volunteer.php" method="post" enctype="multipart/form-data">
                ...
                <!-- One "tab" for each step in the form: -->
                    ...
                    Upload your Resume:
                    <p><input type="File" name="resume" accept=".jpg, .jpg"></p>
                    Your skills:
